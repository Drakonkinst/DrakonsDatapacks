...
execute if predicate dc_enderknife:enchant/model_has_blinking run function dc_enderknife:blinking/setup_blink
execute unless predicate dc_enderknife:enchant/model_has_blinking unless score #IsBroken dc_value matches 1 run function dc_enderknife:drop/drop_survive
