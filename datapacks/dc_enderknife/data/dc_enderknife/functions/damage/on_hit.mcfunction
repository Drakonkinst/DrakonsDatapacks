...
execute store result score #FireDuration dc_value run data get storage dc_enderknife:sword_data FlyingSword.tag.Enchantments[{id:"minecraft:fire_aspect"}].lvl 80
