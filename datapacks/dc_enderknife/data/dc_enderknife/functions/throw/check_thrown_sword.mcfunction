...
data modify storage dc_throwable_swords:item_data ThrownItemData set from entity @s Item
data modify storage dc_throwable_swords:item_data ThrownItemData.tag.Thrower set from entity @s Thrower
...
execute at @s summon item_display run function dc_throwable_swords:throw/setup_thrown_sword
