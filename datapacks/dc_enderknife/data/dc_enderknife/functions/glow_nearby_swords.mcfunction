...
# execute as @e[type=item_display,tag=dc_throwable_model,distance=..250] unless data entity @s HandItems[0].tag.Returning run function dc_throwable_swords:recall/tag_item_display_if_match
