...
execute if entity @s[type=player,gamemode=!creative,gamemode=!spectator,tag=!dc_enderman] if score @s dc_health matches 1..6 if predicate dc_throwable_axes:just_hurt run function dc_throwable_axes:print_death_message
