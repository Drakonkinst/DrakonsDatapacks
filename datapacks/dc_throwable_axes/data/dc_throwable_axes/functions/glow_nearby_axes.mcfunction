...
execute as @e[type=item_display,tag=dc_throwable_model,distance=..250] unless data entity @s HandItems[0].components."minecraft:custom_data".Returning run function dc_throwable_axes:recall/tag_item_display
