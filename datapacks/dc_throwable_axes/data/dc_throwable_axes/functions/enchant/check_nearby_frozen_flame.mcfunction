execute as @e[type=item,distance=..1,predicate=dc_throwable_axes:enchant/is_frozen_flame,limit=1] run tag @s add dc_frozenFlame
...
# Reset
tag @e[type=item,distance=..1] remove dc_frozenFlame
