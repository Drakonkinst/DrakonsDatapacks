...
execute as @e[type=item_display,tag=dc_te_model,distance=1.1..200] if data entity @s item.tag.Returning run function dc_throwable_axes:recall/tag_embed_if_match
execute as @e[type=item_display,tag=dc_te_model,tag=dc_matchingAxe] run function dc_throwable_axes:recall/embed_to_model
