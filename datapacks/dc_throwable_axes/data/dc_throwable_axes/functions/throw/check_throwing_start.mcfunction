...
# Netherite
execute if score @s dc_throwNAxe matches 1.. as @e[type=item,predicate=dc_throwable_axes:new_diamond_axe,limit=1,distance=..5,sort=nearest] at @s run function dc_throwable_axes:throw/check_thrown_axe
