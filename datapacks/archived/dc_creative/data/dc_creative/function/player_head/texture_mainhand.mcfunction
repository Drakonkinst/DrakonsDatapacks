...
data modify entity @e[type=armor_stand,tag=dc_output_holder,limit=1] HandItems[0].tag.SkullOwner.Properties.textures[0].Value set from entity @s SelectedItem.tag.pages[0]
