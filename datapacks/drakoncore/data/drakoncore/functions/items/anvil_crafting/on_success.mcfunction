...
execute unless entity @a[tag=dc_anvilCrafting,limit=1,gamemode=creative] if predicate drakoncore:anvil_crafting/chance_damage_anvil positioned ~ ~-0.2 ~ run function drakoncore:items/anvil_crafting/damage_anvil
