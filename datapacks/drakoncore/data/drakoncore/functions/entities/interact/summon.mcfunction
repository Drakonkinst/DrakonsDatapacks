...
summon villager ~ -64 ~ {ActiveEffects:[{Id:14,Amplifier:0,Duration:20000000,ShowParticles:0b}],Silent:1b,Invulnerable:1b,Offers:{},Tags:["dc_interact","new"],NoAI:1b,Team:"no_collision"}
