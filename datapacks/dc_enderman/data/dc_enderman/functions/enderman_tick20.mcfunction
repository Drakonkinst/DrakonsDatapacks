...
execute unless dimension minecraft:the_nether if score @s dc_EM_sneakTime matches 3.. if predicate dc_enderman:enderpearl_offhand run function dc_enderman:teleport/attempt_random
