...
execute unless score #ChildLocation dc_value matches 1.. if data entity @s SelectedItem.components."minecraft:custom_data"{Nightblood:1b} run scoreboard players set #ChildLocation dc_value 1
execute unless score #ChildLocation dc_value matches 1.. if data entity @s Inventory[{Slot:-106b,components:{"minecraft:custom_data":{Nightblood:1b}}}] run scoreboard players set #ChildLocation dc_value 2
execute unless score #ChildLocation dc_value matches 1.. if data entity @s Inventory[{components:{"minecraft:custom_data":{Nightblood:1b}}}] run scoreboard players set #ChildLocation dc_value 3
execute unless score #ChildLocation dc_value matches 1.. if data entity @s EnderItems[{components:{"minecraft:custom_data":{Nightblood:1b}}}] run scoreboard players set #ChildLocation dc_value 4
