execute if entity @a[distance=..2,tag=dc_werewolfHowlTarget,limit=1,tag=!dc_werewolfTransformed,gamemode=!spectator] run scoreboard players reset #RaycastLength dc_value
