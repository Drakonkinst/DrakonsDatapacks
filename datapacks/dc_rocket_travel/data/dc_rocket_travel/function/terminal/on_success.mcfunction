...
execute if entity @e[type=marker,tag=dc_launchpad,tag=!dc_startingLaunch,distance=..25,limit=1] run tellraw @s ["",{"text":"[","color":"gray"},{"text":"Launchpad Terminal","color":"dark_aqua"},{"text":"] ","color":"gray"},{"selector":"@e[type=marker,tag=dc_rocketLocation,tag=dc_rocketTarget,limit=1]","color":"green"},{"text":" selected! Please proceed to the "},{"text":"Rocket Launchpad","color":"green"},{"text":"."}]
