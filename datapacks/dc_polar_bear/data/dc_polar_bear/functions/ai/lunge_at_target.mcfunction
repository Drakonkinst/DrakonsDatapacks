...
execute if score #Y dc_value matches ..-10 positioned ~ ~-1 ~ run function dc_polar_bear:ai/icebreaker
execute if block ~ ~ ~ water if score #Y dc_value matches ..-10 run scoreboard players remove #Y dc_value 15
...
# Set to cooldown in ticks (150) plus duration of lunge in ticks (10)
scoreboard players set @s dc_polarBearLunge 160
