...
execute if entity @s[type=player,gamemode=!creative,gamemode=!spectator,tag=!dc_enderman,scores={dc_health=1..12},nbt={HurtTime:0s}] run function dc_throwable_axes:print_death_message
execute if entity @s[type=player,gamemode=!creative,gamemode=!spectator,tag=!dc_enderman,scores={dc_health=1..12},nbt={HurtTime:1s}] run function dc_throwable_axes:print_death_message
