...
execute unless block ~ ~ ~ #drakoncore:waterloggable[waterlogged=true] unless block ~ ~ ~ #drakoncore:always_waterlogged unless block ~ ~ ~ minecraft:water run setblock ~ ~ ~ air replace
playsound minecraft:entity.enderman.teleport voice @s ~ ~ ~ 1 0.5
