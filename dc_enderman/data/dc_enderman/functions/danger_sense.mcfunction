...
execute if entity @s[tag=dc_in_water] if predicate dc_enderman:chance_enderman_teleport_water at @s run function dc_enderman:teleport_random
execute if entity @s[tag=!dc_in_water] if predicate dc_enderman:chance_enderman_teleport at @s run function dc_enderman:teleport_random
