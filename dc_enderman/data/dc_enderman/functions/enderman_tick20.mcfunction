...
execute if data entity @s SelectedItem unless predicate dc_enderman:enderpearl_mainhand run scoreboard players reset @s dc_EM_sneakTime
...
execute unless predicate drakoncore:in_nether if score @s dc_EM_sneakTime matches 3.. if predicate dc_enderman:enderpearl_offhand run function dc_enderman:teleport/random
execute if score @s dc_EM_sneakTime matches 3.. if predicate dc_enderman:enderpearl_mainhand run function dc_enderman:teleport/init_raycast
