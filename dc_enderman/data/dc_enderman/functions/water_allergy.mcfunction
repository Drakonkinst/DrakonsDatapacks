...
execute if entity @s[tag=dc_inRainyBiome,tag=!dc_holdingUmbrella] if predicate drakoncore:in_overworld if predicate drakoncore:is_raining if predicate drakoncore:under_sky run effect give @s minecraft:poison 2 2 true
