...
execute if entity @s[tag=!dc_world_reset] if score @s dc_xPos matches 9999000..10001000 if score @s dc_zPos matches -1000..1000 run function dc_world_reset:reset_player