...
execute unless entity @s[tag=dc_hasUmbrella] if predicate dc_umbrella:holding_umbrella run tag @s add dc_hasUmbrella
tag @s[tag=dc_hasUmbrella] add dc_holdingUmbrella